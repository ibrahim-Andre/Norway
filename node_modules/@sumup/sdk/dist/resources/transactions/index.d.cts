...
export declare class Transactions extends APIResource {
     ...
     */
    refund(txnId: string, body?: RefundTransactionParams, options?: RequestOptions): Promise<void>;
    refundWithResponse(txnId: string, body?: RefundTransactionParams, options?: RequestOptions): Promise<WithResponse<void>>;
    /**
     ...
     * - `client_transaction_id`
     */
    getDeprecated(query?: GetTransactionQueryParams, options?: RequestOptions): Promise<TransactionFull>;
    getDeprecatedWithResponse(query?: GetTransactionQueryParams, options?: RequestOptions): Promise<WithResponse<TransactionFull>>;
    /**
     ...
     * Lists detailed history of all transactions associated with the merchant profile.
     */
    listDeprecated(query?: ListTransactionsQueryParams, options?: RequestOptions): Promise<ListTransactionsResponse>;
    listDeprecatedWithResponse(query?: ListTransactionsQueryParams, options?: RequestOptions): Promise<WithResponse<ListTransactionsResponse>>;
}
