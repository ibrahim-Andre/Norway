...
export declare class Receipts extends APIResource {
     ...
     */
    get(id: string, query: GetReceiptQueryParams, options?: RequestOptions): Promise<Receipt>;
    getWithResponse(id: string, query: GetReceiptQueryParams, options?: RequestOptions): Promise<WithResponse<Receipt>>;
}
