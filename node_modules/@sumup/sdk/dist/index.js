...
class Payouts extends APIResource {
    ...
    listDeprecatedWithResponse(query, options) {
        return this._client.getWithResponse({
            path: "/v0.1/me/financials/payouts",
            query,
            ...options
...
class Subaccounts extends APIResource {
    ...
    listSubAccountsWithResponse(query, options) {
        return this._client.getWithResponse({
            path: "/v0.1/me/accounts",
            query,
            ...options
    ...
    createSubAccountWithResponse(body, options) {
        return this._client.postWithResponse({
            path: "/v0.1/me/accounts",
            body,
            ...options
    ...
    compatGetOperatorWithResponse(operatorId, options) {
        return this._client.getWithResponse({
            path: `/v0.1/me/accounts/${operatorId}`,
            ...options
        });
    ...
    updateSubAccountWithResponse(operatorId, body, options) {
        return this._client.putWithResponse({
            path: `/v0.1/me/accounts/${operatorId}`,
            body,
            ...options
...
class Transactions extends APIResource {
    ...
    refundWithResponse(txnId, body, options) {
        return this._client.postWithResponse({
            path: `/v0.1/me/refund/${txnId}`,
            body,
            ...options
    ...
    getDeprecatedWithResponse(query, options) {
        return this._client.getWithResponse({
            path: "/v0.1/me/transactions",
            query,
            ...options
...
const src = SumUp;
export default src;
export { APIError, Checkouts, Customers, Members, Memberships, Merchants, Payouts, Readers, Receipts, Roles, Subaccounts, SumUp, SumUpError, Transactions };
